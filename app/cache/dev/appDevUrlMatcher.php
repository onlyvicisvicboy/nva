...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/index')) {
            // _indexnva
            if (preg_match('#^/index/(?P<name>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => '_indexnva')), array (  '_controller' => 'Nva\\FontBundle\\Controller\\DefaultController::indexAction',));
            }

            // nva_index
            if ($pathinfo === '/indexnva') {
                return array (  '_controller' => 'Nva\\FontBundle\\Controller\\DefaultController::indexnvaAction',  '_route' => 'nva_index',);
            }
